...
import { CheckCircle2, Cloud, KeyRound, Save, TestTube2 } from 'lucide-react';
...
export default function PlatformSourceFetchSettingsPage() {
  ...
  if (!isSuperAdmin) {
    return (
      <ProtectedLayout title="Worker Deska">
  ...
  return (
    <ProtectedLayout>
      <main className="mx-auto w-full max-w-4xl space-y-6" dir="rtl">
        <PageHeader
          title="Worker Deska"
          description="تنها Worker دریافت منبع برای تلگرام و X — مشترک بین همه سازمان‌ها."
          icon={Cloud}
        />
          ...
          <Card className="space-y-6 p-5 sm:p-6">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                پس از <code dir="ltr">pnpm worker:deploy</code> آدرس Worker را اینجا ثبت کنید. Workerهای قدیمی (<code dir="ltr">source-fetch</code>, <code dir="ltr">telegram-bridge</code>) را از داشبورد Cloudflare حذف کنید.
              </p>
            </div>
