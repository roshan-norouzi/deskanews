...
import { ArrowLeft, FileBarChart2, Newspaper, PanelsTopLeft, Rss, Settings2, Share2 } from 'lucide-react';
...
const sections = [
  ...
  { href: '/publishing/media', title: 'مدیریت رسانه', text: 'مشاهده، ویرایش و انتشار نوشته‌های سایت WordPress متصل.', icon: PanelsTopLeft, tone: 'bg-sky-50 text-sky-700' },
