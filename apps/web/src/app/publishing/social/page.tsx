...
export default function SocialPage() {
  ...
  return <ProtectedLayout><PageContainer>
    ...
    {feeds.length === 0 && <Card className="flex min-h-48 flex-col items-center justify-center p-8 text-center"><Rss className="h-9 w-9 text-slate-300" /><h2 className="mt-4 font-bold text-slate-900">هنوز منبع اجتماعی ندارید</h2><p className="mt-2 text-sm text-slate-500">منابع استودیوی اجتماعی مستقل از میز خبر هستند.</p><Link href="/publishing/social/feeds" className="mt-5 rounded-xl bg-primary-600 px-4 py-2 text-sm font-semibold text-white">افزودن منبع</Link></Card>}
